...
export const theme = darkMode => ({
  white,
  black,
  textColor: darkMode ? white : '#515151',
  invertedTextColor: darkMode ? '#515151' : white,
  ...
  shadowColor: darkMode ? '#000' : '#FFF19F',
  ...
  colors: {
    ...
    link: darkMode ? '#FFF19F' : '#3ab7ab',
    invertedLink: darkMode ? '#FFF19F' : '#3ab7ab'
  },
