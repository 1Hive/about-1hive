...
<Info>
UniswapV2Router01 should not be used any longer, because of the discovery of a <Link to='/docs/honeyswap/smart-contracts/router01#getamountin'>low severity bug</Link> and the fact that some methods do not work with tokens that take fees on transfer. The current recommendation is to use <Link to='/docs/honeyswap/smart-contracts/router02'>UniswapV2Router02</Link>.
</Info>
...
Returns <Link to='/docs/honeyswap/smart-contracts/factory/#address'>factory address</Link>.
...
Removes liquidity from an ERC-20⇄ERC-20 pool without pre-approval, thanks to <Link to='/docs/honeyswap/smart-contracts/pair-erc-20/#permit'>permit</Link>.
...
Removes liquidity from an ERC-20⇄WETTH pool and receive ETH without pre-approval, thanks to <Link to='/docs/honeyswap/smart-contracts/pair-erc-20/#permit'>permit</Link>.
...
See <Link to='/docs/honeyswap/smart-contracts/library#quote'>quote</Link>.

## getAmountOut

See <Link to='/docs/honeyswap/smart-contracts/library#getamountout'>getAmountOut</Link>.
...
See <Link to='/docs/honeyswap/smart-contracts/library#getamountsout'>getAmountsOut</Link>.
...
See <Link to='/docs/honeyswap/smart-contracts/library#getamountsin'>getAmountsIn</Link>.
