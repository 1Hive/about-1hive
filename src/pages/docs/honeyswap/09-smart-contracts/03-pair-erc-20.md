...
This documentation covers ERC-20 functionality for denominating pool tokens. For Uniswap-specific functionality, see <Link to='/docs/honeyswap/smart-contracts/pair'>Pair</Link>.
...
Emitted each time a transfer occurs via [transfer](#transfer-1), [transferFrom](#transferfrom), <Link to='/docs/honeyswap/smart-contracts/exchange#mint-1'>mint</Link>, or <Link to='/docs/honeyswap/smart-contracts/exchange#burn-1'>burn</Link>.
...
- See <Link to='/docs/honeyswap/technical-considerations/using-permit'>Using Permit</Link>.
- Emits [Approval](#approval).
