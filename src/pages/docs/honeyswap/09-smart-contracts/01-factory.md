...
[`UniswapV2Factory.sol`](https://github.com/1Hive/uniswap-v2-core/blob/master/contracts/UniswapV2Factory.sol)

# Address

`UniswapV2Factory` is deployed at `0xA818b4F111Ccac7AA31D0BCc0806d64F2E0737D7` on [xDai](https://blockscout.com/address/0xA818b4F111Ccac7AA31D0BCc0806d64F2E0737D7).
...
- Pair addresses can also be calculated deterministically, see <Link to='/docs/honeyswap/technical-considerations/pair-addresses'>Pair Addresses</Link>.
...
See <Link to='/docs/honeyswap/smart-contracts/architecture/#protocol-charge-calculation'>Protocol Charge Calculation</Link>.
